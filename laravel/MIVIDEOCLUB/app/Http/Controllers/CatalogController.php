...
{
    // Vaya fumada de array te vas a tener que copiar aquí del archivo que te dieron.
private $arrayPeliculas = array(
    ...
    public function getShow($id) {
        // Pillamos la peli concreta del array y se la tiramos a la vista
...
public function getEdit($id)
{
    ...
    return view('catalog.edit', array('pelicula' => $this->arrayPeliculas[$id], 'id' => $id));
}
}